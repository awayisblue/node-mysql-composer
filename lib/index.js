...
Composer.prototype.beginTransaction = function(callback){
    if(callback)return this.connection.beginTransaction(callback)
...
Composer.prototype.rollback = function(callback){
    if(callback)return this.connection.rollback(callback)
    var connection = this.connection
    return new Promise(function(resolve,reject){
...
Composer.prototype.commit = function(callback){
    if(callback)return this.connection.commit(callback)
    var connection = this.connection
    return new Promise(function(resolve,reject){
